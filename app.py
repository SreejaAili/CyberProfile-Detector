...
st.set_page_config(page_title="ProfileGuard AI", page_icon="🔍", layout="wide")
...
# Transparent matching box
        glass = (15/255, 18/255, 40/255, 0.55)

        fig.patch.set_facecolor(glass)
        ax.set_facecolor(glass)
...
# White text
        ...
        ax2.pie([result["votes_fake"], result["votes_real"]],
                ...
                colors=["#c84527","#55efc4"], startangle=90,
                textprops={'fontsize':8, 'color':'white'})
        glass = (15/255, 18/255, 40/255, 0.55)
        fig2.patch.set_facecolor(glass)
        ...
        ax3.pie([avg_fake, avg_real],
                ...
                autopct="%1.1f%%",
                colors=["#c84527","#55efc4"],
                startangle=90,
                textprops={'fontsize':8, 'color':'white'})
        # Transparent matching box
        fig3.patch.set_facecolor(glass)
        ax3.set_facecolor(glass)
